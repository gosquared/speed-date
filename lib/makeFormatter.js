  ...
  while (str.length) {
    switch (str.charAt(0)) {
      case 'M':
        ...
        if (/^MMMM/.test(str)) {
          add(
            '["January","February","March","April","May","June","July","August","September","October","November","December"][_month]',
          );
          nxt(4);
          continue;
        }
        if (/^MMM/.test(str)) {
          add(
            '["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][_month]',
          );
          nxt(3);
          continue;
        }
      ...
      case 'd':
        ...
        if (/^dddd/.test(str)) {
          add(
            '["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][_day]',
          );
          nxt(4);
          continue;
        }
        ...
        if (/^do/.test(str)) {
          add('_day');
          add(
            '_day === 1 ? "st" : _day === 2 ? "nd" : _day === 3 ? "rd" : "th"',
          );
          nxt(2);
          continue;
        }
